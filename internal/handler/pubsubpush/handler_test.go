...
func TestEventHandler_Handle(t *testing.T) {
	t.Run("push受け口の応答変換", func(t *testing.T) {
		t.Run("push envelopeがJSONとして解析できないとき、400を返す", func(t *testing.T) {
		...
		t.Run("push envelopeのmessage.dataが空のとき、400を返す", func(t *testing.T) {
			h := pubsubpush.NewEventHandler(func(ctx context.Context, data []byte) error { return nil })
		...
		t.Run("message.dataがbase64として不正なとき、400を返す", func(t *testing.T) {
			h := pubsubpush.NewEventHandler(func(ctx context.Context, data []byte) error { return nil })
		...
		t.Run("message.dataが正しくbase64デコードできるとき、デコード結果を処理関数の引数として渡す", func(t *testing.T) {
			var received []byte
		...
		t.Run("処理関数がエラーを返したとき、500を返す", func(t *testing.T) {
			h := pubsubpush.NewEventHandler(func(ctx context.Context, data []byte) error {
		...
		t.Run("処理関数がエラーを返さなかったとき、200を返す", func(t *testing.T) {
			h := pubsubpush.NewEventHandler(func(ctx context.Context, data []byte) error { return nil })
