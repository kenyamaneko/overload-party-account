...
func TestPlayerRepository_ReferenceMethodsNotFound(t *testing.T) {
	t.Run("PlayerRepository", func(t *testing.T) {
		t.Run("参照系メソッドに共通する仕様", func(t *testing.T) {
			...
			t.Run("GetProgressionは、存在しないplayer_idを指定したとき、見つからないことを示すエラーを返す", func(t *testing.T) {
				sharedPg.Truncate(t)
				repo := postgres.NewPlayerRepository(sharedPg.Pool)
			...
			t.Run("GetProgressionForUpdateは、存在しないplayer_idを指定したとき、見つからないことを示すエラーを返す", func(t *testing.T) {
				sharedPg.Truncate(t)
				repo := postgres.NewPlayerRepository(sharedPg.Pool)
			...
			t.Run("GetOnboardingStatusは、存在しないplayer_idを指定したとき、見つからないことを示すエラーを返す", func(t *testing.T) {
				sharedPg.Truncate(t)
				repo := postgres.NewPlayerRepository(sharedPg.Pool)
...
func TestPlayerRepository_UpdateMethodsNotFound(t *testing.T) {
	t.Run("PlayerRepository", func(t *testing.T) {
		t.Run("更新系メソッドに共通する仕様", func(t *testing.T) {
			t.Run("UpdateNameは、存在しないplayer_idを指定したとき、見つからないことを示すエラーを返す", func(t *testing.T) {
				sharedPg.Truncate(t)
				repo := postgres.NewPlayerRepository(sharedPg.Pool)
			...
			t.Run("UpdatePremiumは、存在しないplayer_idを指定したとき、見つからないことを示すエラーを返す", func(t *testing.T) {
				sharedPg.Truncate(t)
				repo := postgres.NewPlayerRepository(sharedPg.Pool)
			...
			t.Run("UpdateProgressionは、存在しないplayer_idを指定したとき、見つからないことを示すエラーを返す", func(t *testing.T) {
				sharedPg.Truncate(t)
				repo := postgres.NewPlayerRepository(sharedPg.Pool)
			...
			t.Run("UpdateOnboardingStatusは、存在しないplayer_idを指定したとき、見つからないことを示すエラーを返す", func(t *testing.T) {
				sharedPg.Truncate(t)
				repo := postgres.NewPlayerRepository(sharedPg.Pool)
...
func TestPlayerRepository_Create(t *testing.T) {
	t.Run("PlayerRepository", func(t *testing.T) {
		t.Run("Createは、指定したplayerの行と、レベル1・経験値0のprogression行を1回の呼び出しで両方作成する", func(t *testing.T) {
			sharedPg.Truncate(t)
...
func TestPlayerRepository_Exists(t *testing.T) {
	t.Run("PlayerRepository", func(t *testing.T) {
		t.Run("Existsは、対象が存在するとき、trueを返す", func(t *testing.T) {
			sharedPg.Truncate(t)
			player := createTestPlayer(t)
			repo := postgres.NewPlayerRepository(sharedPg.Pool)
		...
		t.Run("Existsは、対象が存在しないとき、エラーにはせずfalseを返す", func(t *testing.T) {
			sharedPg.Truncate(t)
			repo := postgres.NewPlayerRepository(sharedPg.Pool)
...
func TestPlayerRepository_ExistsByFirebaseUID(t *testing.T) {
	t.Run("PlayerRepository", func(t *testing.T) {
		t.Run("ExistsByFirebaseUIDは、対象が存在するとき、trueを返す", func(t *testing.T) {
			sharedPg.Truncate(t)
			player := createTestPlayer(t)
			repo := postgres.NewPlayerRepository(sharedPg.Pool)
		...
		t.Run("ExistsByFirebaseUIDは、対象が存在しないとき、エラーにはせずfalseを返す", func(t *testing.T) {
			sharedPg.Truncate(t)
			repo := postgres.NewPlayerRepository(sharedPg.Pool)
...
func TestPlayerRepository_GetDailyBattle(t *testing.T) {
	t.Run("PlayerRepository", func(t *testing.T) {
		t.Run("GetDailyBattleは、指定したplayer_idとgame_dateの組に一致する行が無いとき、エラーにはせずnilを返す", func(t *testing.T) {
			sharedPg.Truncate(t)
			player := createTestPlayer(t)
			repo := postgres.NewPlayerRepository(sharedPg.Pool)
		...
		t.Run("GetDailyBattleは、指定したplayer_idとgame_dateの組に一致する行だけを返す(別の日付の記録があっても混同しない)", func(t *testing.T) {
			sharedPg.Truncate(t)
			player := createTestPlayer(t)
			repo := postgres.NewPlayerRepository(sharedPg.Pool)
...
func TestPlayerRepository_IncrementDailyBattleCount(t *testing.T) {
	t.Run("PlayerRepository", func(t *testing.T) {
		t.Run("IncrementDailyBattleCountは、対象日の記録が無いとき、新規に記録を作成しカウントを1として返す", func(t *testing.T) {
			sharedPg.Truncate(t)
			player := createTestPlayer(t)
			repo := postgres.NewPlayerRepository(sharedPg.Pool)
		...
		t.Run("IncrementDailyBattleCountは、対象日の記録が既にあるとき、カウントを1加算した値を返す", func(t *testing.T) {
			sharedPg.Truncate(t)
			player := createTestPlayer(t)
			repo := postgres.NewPlayerRepository(sharedPg.Pool)
