...
func TestComputeExpProgress(t *testing.T) {
	t.Run("レベル進捗計算", func(t *testing.T) {
		...
		t.Run("累計経験値が開始閾値ちょうどのとき、LevelExpCurrentは0になる", func(t *testing.T) {
		...
		t.Run("累計経験値が開始閾値を超えているとき、LevelExpCurrentは累計経験値から開始閾値を引いた値になる", func(t *testing.T) {
		...
		t.Run("LevelExpRequiredは次レベル必要経験値から現在レベルの開始閾値を引いた値になる", func(t *testing.T) {
